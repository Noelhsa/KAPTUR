...
class _PantallaGeneracionReporteState extends State<PantallaGeneracionReporte> {
  ...
  Future<void> _confirmar() async {
    ...
    try {
      ...
      // Regresar a la pantalla de inspecciones
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
            child: Text('GENERACIÓN DE REPORTE',
                style: Theme.of(context)
                    .textTheme
                    .titleMedium
                    ?.copyWith(letterSpacing: 2, color: AppColors.navy))),
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 4),
          decoration: BoxDecoration(
              color: AppColors.navy.withOpacity(0.1),
              borderRadius: BorderRadius.circular(20)),
          child: Text('Folio #${widget.folio}',
              style: TextStyle(
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _seccion(
          ...
          personas.isEmpty
              ? [
                  const Text('Sin personas registradas',
        ...
        _seccion(
          ...
          actos.isEmpty
              ? [
                  const Text('Sin actos registrados',
                      style: TextStyle(color: Colors.black54, fontSize: 13))
                ]
          ...
          Expanded(
            ...
            child: ElevatedButton(
              ...
              child: _confirmando
                  ...
                  : const Text('CONFIRMAR Y ENVIAR AL JEFE',
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.w700,
                          letterSpacing: 0.5,
  ...
  Widget _chipActo(Map<String, dynamic> a) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(color: Colors.grey.shade200)),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(a['opcion_acto']?.toString() ?? '—',
            style: const TextStyle(
                color: Colors.black87,
                fontSize: 13,
                fontWeight: FontWeight.w600)),
        const SizedBox(height: 4),
        Text(a['tipo_acto']?.toString() ?? '',
            style: TextStyle(color: Colors.grey.shade600, fontSize: 11)),
        const SizedBox(height: 6),
        Row(children: [
          _badge(sev, sevColor),
          const SizedBox(width: 6),
          Text('${a['cantidad_personas']} persona(s)',
              style: TextStyle(color: Colors.grey.shade600, fontSize: 11)),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          Text(e['tipo_archivo']?.toString() ?? 'Archivo',
              style: const TextStyle(
                  color: Colors.black87,
                  fontSize: 12,
                  fontWeight: FontWeight.w500)),
  ...
  Widget _buildError() {
    return Center(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const SizedBox(height: 16),
        ElevatedButton(
            onPressed: _cargarDetalle, child: const Text('Reintentar')),
      ]),
    ));
  }
